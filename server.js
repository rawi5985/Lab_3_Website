...
app.get('/player_info',function(req,res){
	var playerQuery = 'select name from football_players';
	db.any(playerQuery)
		.then(data=>{
			res.render('pages/player_info',{my_title:'Player Stats',players:data,playerChoice:''})
		})
		.catch(err=>{console.log('err',err);
		res.render('pages/player_info',{my_title:'title',players:'',playerChoice:''})
})
});
